...
module.exports = class extends Command {
    ...
    async run(msg, [query]) {
        ...
        if (!voiceChannel) return msg.send('Join a channel and try again');
        ...
        if (
            ...
            try {
              ...
              if (msg.guild.musicData.isPlaying == false) {
                ...
                return this.playSong(message.guild.musicData.queue, msg);
              ...
              console.error(err);
              return msg.send('Playlist is either private or it does not exist');
            }
          }
          ...
          if (query.match(/^(http(s)?:\/\/)?((w){3}.)?youtu(be|.be)?(\.com)?\/.+/)) {
            ...
            try {
              ...
              if (
                ...
                return msg.send(`${song.title} added to queue`);
              }
            } catch (err) {
              console.error(err);
              return msg.send('Something went wrong, please try later');
            }
          }
          try {
            ...
            const embed = new MessageEmbed()
              ...
              .addField('Exit', 'exit');
            var songEmbed = await msg.send({ embed });
            try {
            ...
            if (msg.guild.musicData.isPlaying == false) {
              ...
              this.playSong(msg.guild.musicData.queue, msg);
            } else if (msg.guild.musicData.isPlaying == true) {
              if (songEmbed) {
                songEmbed.delete();
              }
